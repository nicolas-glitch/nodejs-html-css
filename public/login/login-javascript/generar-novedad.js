...
const uidnovedad = localStorage.getItem('_idCita');

let url =`http://localhost:8080/api/novedades/${uidnovedad}`;
...
formulario.addEventListener('submit', ev =>{
    ...
    .then((data) =>{
        ...
        //mostrar que la novedad  fue creada correctamente
            mensaje.style.color= '#1f4';
            mensaje.style.display='';
            mensaje.innerHTML = 'novedad creada';
            return setTimeout(() =>{
                mensaje.style.display='none';
            },3000);
